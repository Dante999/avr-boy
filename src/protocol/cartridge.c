...
// {
// 	protocol_package_send(CMD_REQ_VERSION, own_version, 0);
...
// {
// 	protocol_package_send(CMD_REQ_PING, 0, 0);
...
uint8_t cartridge_ping(void)
{
	...
	if (m_received.cmd == CMD_RES_PING)
...
// {
// 	protocol_package_send(CMD_REQ_VERSION, 1, COM_VERSION);
// 	protocol_package_receive(&m_received);
